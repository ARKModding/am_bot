...
from ..constants import BOOSTS_COUNT_CHANNEL_ID, GUILD_ID, MODDER_ROLE_ID, MAPPER_ROLE_ID, MODDER_STATS_CHANNEL_ID, \
    MAPPER_STATS_CHANNEL_ID, MEMBERS_COUNT_CHANNEL_ID
...
class ServerStatsCog(commands.Cog):
    ...
    async def update_boost_count(self):
        ...
        await channel.edit(name=f'🔸┇{self.guild.premium_subscription_count}︲boosts')
    ...
    async def update_server_stats(self):
        ...
        while True:
            ...
            logger.debug(f'Server Stats updated! Sleeping 10 minutes...')
